...
hidden_total_t = 0
cols_to_use = ['Household 1', 'Household 2', 'Range']
...
def plot_rects(df, ax, rects, column_x, column_y, edgecolor='black', facecolor='none'):
    for (xl, yl),(xr, yr) in rects:
        ax.add_patch(patches.Rectangle((xl,yl),xr-xl,yr-yl,linewidth=5,edgecolor=edgecolor,facecolor=facecolor, alpha=0.5))
...
ax = pl.subplot(111)
plot_rects(df, ax, rects, column_x, column_y, facecolor='c')
